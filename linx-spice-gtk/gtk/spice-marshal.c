                                                       ...
                                                       gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_INT_INT_INT_POINTER) (gpointer     data1,
                                                              ...
                                                              gpointer     arg_5,
                                                              gpointer     data2);
  GMarshalFunc_VOID__INT_INT_INT_INT_POINTER callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                                           ...
                                                           gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_INT_INT_INT_INT_POINTER) (gpointer     data1,
                                                                  ...
                                                                  gpointer     arg_6,
                                                                  gpointer     data2);
  GMarshalFunc_VOID__INT_INT_INT_INT_INT_POINTER callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                               ...
                                               gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__POINTER_UINT) (gpointer     data1,
                                                          ...
                                                          guint        arg_2,
                                                          gpointer     data2);
  GMarshalFunc_BOOLEAN__POINTER_UINT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  gboolean v_return;
                                                 ...
                                                 gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_POINTER_UINT) (gpointer     data1,
                                                        ...
                                                        guint        arg_3,
                                                        gpointer     data2);
  GMarshalFunc_VOID__UINT_POINTER_UINT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                                      ...
                                                      gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_UINT_POINTER_UINT) (gpointer     data1,
                                                             ...
                                                             guint        arg_4,
                                                             gpointer     data2);
  GMarshalFunc_VOID__UINT_UINT_POINTER_UINT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                                    ...
                                                    gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__UINT_POINTER_UINT) (gpointer     data1,
                                                               ...
                                                               guint        arg_3,
                                                               gpointer     data2);
  GMarshalFunc_BOOLEAN__UINT_POINTER_UINT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  gboolean v_return;
